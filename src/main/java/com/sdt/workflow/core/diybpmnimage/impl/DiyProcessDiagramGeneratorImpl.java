 ...
 * @date 2019/11/20
 */
public class DiyProcessDiagramGeneratorImpl extends DefaultProcessDiagramGenerator implements IDiyProcessDiagramGenerator {

    /**
     * 预初始化流程图绘制，大大提升了系统启动后首次查看流程图的速度
     */
    static {
        new DiyProcessDiagramCanvas(10, 10, 0, 0, "png", "宋体", "宋体", "宋体", null);
    }

    protected static DiyProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
        ...
        return new DiyProcessDiagramCanvas((int) maxX + 10, (int) maxY + 10, (int) minX, (int) minY,
     ...
     * @param colors                颜色
     * @param currIds
     * @return {@link DiyProcessDiagramCanvas}
     */
    public DiyProcessDiagramCanvas generateProcessDiagram(BpmnModel bpmnModel, String imageType,
        ...
        DiyProcessDiagramCanvas processDiagramCanvas = initProcessDiagramCanvas(bpmnModel, imageType, activityFontName, labelFontName, annotationFontName, customClassLoader);
     ...
     * 画节点
     *
     * @param processDiagramCanvas  {@link DiyProcessDiagramCanvas}
     * @param bpmnModel             模型
     * @param flowNode              节点
     * @param highLightedActivities 高亮节点
     * @param highLightedFlows      高亮线条
     ...
     * @param currIds
     */
    protected void drawActivity(DiyProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode,
        ...
        if (null != drawInstruction) {
            ...
            if (CommonUtils.equals(1.0, scaleFactor)) {
        ...
        for (SequenceFlow sequenceFlow : flowNode.getOutgoingFlows()) {
            ...
            if (null != defaultFlow && defaultFlow.equalsIgnoreCase(flowId)) {
                isDefault = true;
            }
     ...
     * 标高亮
     *
     * @param isStartOrEnd         判断哪
     * @param processDiagramCanvas {@link DiyProcessDiagramCanvas}
     * @param graphicInfo          画图信息
     * @param color                颜色
     */
    protected void drawHighLight(boolean isStartOrEnd, DiyProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo, Color color) {
    ...
    public InputStream generateDiagram(BpmnModel bpmnModel, String imageType, List<String> highLightedActivities,
        ...
        DiyProcessDiagramCanvas customProcessDiagramCanvas = generateProcessDiagram(bpmnModel, imageType, highLightedActivities, highLightedFlows,
